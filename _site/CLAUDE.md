...
Tale is a minimal Jekyll 4.x theme for storytellers, packaged as a Ruby gem (v0.2.1). It produces a static blog site with support for sidenotes, math rendering (MathJax), syntax highlighting (Highlight.js), and hover popups.
...
- **sidenotes.js** — Converts footnotes to Tufte-style sidenotes on desktop (jQuery plugin)
- **highlight-code.js** — Syntax highlighting with line numbers via Highlight.js
- **popup-lite.js** — Rich hover popups using custom `data-*` attributes (vanilla JS)
...
│   │   ├── popup-lite.js       # Hover popups via data-* attributes
...
2. **`_layouts/default.html`** (end of body) — MathJax, Highlight.js + line numbers plugin, highlight-code.js, popup-lite.js
